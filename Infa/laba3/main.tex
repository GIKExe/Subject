...
\begin{document}
	...
	\section*{Выводы}
	Выполняя данную работу закрепил умение работать с циклами, функциями, представлением числе в основных ворматах и форматах с плавающей точкой. Научился критически мыслить и выявлять ошибки в программе.
