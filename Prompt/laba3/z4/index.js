...
document.getElementById('generate-btn').addEventListener('click', () => {
	...
	if (sigma <= 0) {
		showError('Стандартное отклонение (σ) должно быть больше 0.');
		return;
	}

	// 3. Предупреждение о слишком большом σ
	if (sigma > 1000) {
		console.warn('Внимание: Высокое значение σ (>1000) может сделать гистограмму неинформативной из-за огромного разброса данных.');
		// Можно также вывести мягкое предупреждение в UI, не блокируя выполнение
		showError('Предупреждение: При σ > 1000 график может выглядеть слишком плоским.');
	}
