...
\begin{document}
	...
	\newpage
	\section*{Выводы}
	В ходе лабораторной работы я научился программировать микроконтроллер для управления разной периферией: семисегментными индикаторами, ЖК-дисплеем, светодиодными матрицами 8x8 и мотором. Отработал алгоритмические проверки чисел – составные, двоичные палиндромы, числа Харшада – и выводил их на индикаторы через счётчик нажатий или автоматически. Освоил потактовую генерацию сигналов для микросхемы К176ИЕ4. Реализовал логику включения мотора при одновременном срабатывании двух разных датчиков. Сделал анимацию на матрице Тройка с переключением по таймеру, а на АЛС340А1 – динамический вывод буквы и цифры. Закрепил понимание динамической индикации, работы с драйверами и библиотеками. Всё собрал и отладил на реальном железе.
\end{document}